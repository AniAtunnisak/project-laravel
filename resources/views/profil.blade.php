        ...
        <div class="container slider-top-text">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3 class="my-heading">HALAMAN <span class="bg-main">PROFIL</span></h3>
                    <br>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 wow fadeInUp">
                <h3 class="title-heading text-center font-weight-bold">Profil</h3>
            </div>
        </div>
        <div class="row">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="bio-image">
                          <img src="image/g4.jpg" alt="image" />
                        </div>			
                      </div>
                    </div>	
                  </div>
                  <div class="col-md-6">
                    <div class="bio-content">
                      ...
                      <br>
                      <h5>Nama : Ani Atunisak</h5><h5> Kelas : XII RPL-1</h5><h5> Jurusan : REkayasa Perangkat Lunak</h5><h5>Sekolah : SMKN 1 Purwosari</h5><h5> Tempat/Tanggal Lahir : Pasuruan/ 1 Desember 2003</h5>
                      <h5>Alamat : Dsn. Gunungsari Ds. Kertosari</h5>
                    </div>
                  </div>
                </div>	
              </div>
