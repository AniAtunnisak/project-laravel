...
<html lang="en">
   <head>
      ...
      header.masthead {
          ...
          background: url(' image/g3.jpg') no-repeat center center;
      ...
      */
      ...
      .mybg-music {
          background: url('image/g5.jpg') no-repeat center center fixed;
          background-size: cover;
      }
        ...
        <div class="container slider-top-text">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3 class="my-heading">HALAMAN <span class="bg-main">GALERI</span></h3>
                    <br>
                    <h4 class="myp-slider text-center"><b>Tugas membuat web menggunakan framwork laravel</b></h4>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 wow fadeInUp">
                <h3 class="title-heading text-center font-weight-bold">Galeri</h3>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/e1.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/e1.jpg">
                    </a>
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/e2.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/e2.jpg">
                    </a>
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/e3.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/e3.jpg">
                    </a>
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/e4.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/e4.jpg">
                    </a>
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/e5.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/e5.jpeg">
                    </a>
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/e6.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/e6.jpg">
                    </a>
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/e7.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/e7.jpg">
                    </a>
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/e8.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/e8.jpg">
                    </a>
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/e9.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/e9.jpg">
                    </a>
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/e10.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/e10.jpg">
                    </a>
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/e11.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/e11.jpg">
                    </a>
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/e12.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/e12.jpg">
                    </a>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 text-center text-lg-left my-auto  wow zoomIn">
                    ...
                    <p style="color:rgb(255, 255, 255);">* Ani Atunisak</p>
                    <p style="color:rgb(255, 255, 255);">* Rekayasa Perangkat Lunak</p>
                </div>
